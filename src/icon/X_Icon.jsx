...
export const X_Icon = () => {
  return (
    <div>
      <svg className="modal_box" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="35px" height="35px" preserveAspectRatio="xMidYMid meet" viewBox="0 0 16 16">
